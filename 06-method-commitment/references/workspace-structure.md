...
Only `committed_method_design.md` is a normal source for experiment design, positioning, or risk-objection workflows. Baseline and metric selection are part of experiment design.
