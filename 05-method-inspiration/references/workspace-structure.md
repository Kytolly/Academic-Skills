...
Later experiment design, positioning, or risk-objection workflows should use a human-owned Committed Method Design as their main source. Baseline and metric selection are part of experiment design. Candidate Methods may inform that design, but they should not be treated as the paper's actual method.
