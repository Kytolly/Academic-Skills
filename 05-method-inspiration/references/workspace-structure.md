...
Later experiment design, baseline search, metric search, positioning, or risk-objection workflows should use a human-owned Committed Method Design as their main source. Candidate Methods may inform that design, but they should not be treated as the paper's actual method.
