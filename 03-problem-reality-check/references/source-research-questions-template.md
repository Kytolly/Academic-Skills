...
- {Why this card is the single card being checked now}

## Routing Notes

- {Any ambiguity, missing metadata, or rejected alternative card}

## Decision

Use this Research Question Workspace for the Problem Reality Check: Yes / No

Decision rationale:

- {Why this workspace and selected card are sufficient to proceed, or what blocks routing}
